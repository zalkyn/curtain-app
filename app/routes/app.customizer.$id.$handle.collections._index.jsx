import { Box, Button, ButtonGroup, Card, FormLayout, Icon, InlineStack, Layout, Page, Text, TextField } from "@shopify/polaris";
...
export const loader = async ({ request, params }) => {
    ...
    try {
        ...
        const collections = customizers[0]?.collections || []
...
export default function Collections() {
    ...
    const { collections, customizer, is: customizerId, handle: customizerHandle } = useLoaderData()
    ...
    return <Page
        title={<InlineStack>
            ...
            <Text variant="headingLg">Collections with sub collections</Text>
        </InlineStack>}
                ...
                <Layout.Section>
                    <Card>
                        ...
                        <Suspense fallback={<div>Loading Editor...</div>}>
                            <TextEditor showImage={false} content={newCollectionInputs?.info} setContent={(value) => { handleCollectionInputChange(value, "info") }} />
                        </Suspense>
