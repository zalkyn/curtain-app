...
export const action = async ({ request }) => {
    ...
    switch (role) {
            ...
            try {
                ...
                let swatches = swatchesMetadata?.map(swatch => {
                    ...
                    return {
                        ...
                        title: swatch?.name,
                        handle: slugify(swatch?.name),
                        image64: swatch?.image64,
                        price: parseFloat(swatch?.price) || 0,
                        showPremadeImage: swatch?.showPremadeImage || false,
                        info: swatch?.info,
                        shortInfo: swatch?.shortInfo
                    }
                })
        ...
        case "update-list":
            ...
            console.log("_updateList.info=========", _updateList.info)
        ...
        case "update-single-swatch":
            try {
                ...
                const updateSwatchImage64 = formDataRaw.get("image64")
                if (rawData == null) {
                ...
                await prisma.swatch.updateMany({
                    ...
                    data: {
                        ...
                        image64: updateSwatchImage64 ? updateSwatchImage64 : uss_data?.image64
